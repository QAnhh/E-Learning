							...
							<div class="x_title">
								<h2>Edit</h2>
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="#" method="post">
										...
										<div class="item form-group">
											<label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">permission ID </label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="permissionID" class="form-control" value="<?php echo $profile['permission_id'] ?>">
											</div>
										</div>
										<div class="ln_solid"></div>
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												<a href="manageDatabase.php?page=role_permissions" class="btn btn-primary ">Back</a>
			...
			if($roleID=="") {
	       	...
	       	else
	       	{
	          	try
	          	{
					...
					$stmt = $conn->prepare($sql);
					$stmt->execute();
					header("location: manageDatabase.php?page=role_permissions");
					...
					<div class="x_content">
						...
						<form id="demo-form" data-parsley-validate class="form-horizontal form-label-left" action="#" method="post">
							...
							<div class="item form-group">
								<label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">permission ID </label>
								<div class="col-md-6 col-sm-6 ">
									<input type="text" name="permissionID" class="form-control" />
								</div>
							</div>					
							<div class="ln_solid"></div>
							<div class="item form-group">
...
?>
		<td>
			<a href="manageDatabase.php?page=role_permissions&&edit=<?php echo $row['id'];?>" class=" btn-outline-dark ">Sửa</a>
			<a href="manageDatabase.php?page=role_permissions&&del=<?php echo $row['id'];?>" class=" btn-outline-dark ">Xóa</a>
		</td>
		</tr>
<?php
	}
?>
					...
					<a href="manageDatabase.php?page=role_permissions&&insert" class="btn btn-outline-dark" >Thêm</a>
                    </div>
                  </div>
                </div>
              </div>
