							...
							<div class="x_title">
								<h2>Edit</h2>
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="#" method="post">
										...
										<div class="item form-group">
											<label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">code </label>
											<div class="col-md-6 col-sm-6 ">
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												<a href="manageDatabase.php?page=permissions" class="btn btn-primary ">Back</a>
			...
			if($name=="") {
	       	...
	       	else
	       	{
	          	try
	          	{
					...
					$stmt = $conn->prepare($sql);
					$stmt->execute();
					header("location: manageDatabase.php?page=permissions");
			...
			if($name=="") {
	       	...
	       	else
	       	{
		        try
		        {
	             	...
	             	$sql = "INSERT into permissions (name,code,description)
...
?>
		<td>
			<a href="manageDatabase.php?page=permissions&&edit=<?php echo $row['id'];?>" class=" btn-outline-dark ">Sửa</a>
			<a href="manageDatabase.php?page=permissions&&del=<?php echo $row['id'];?>" class=" btn-outline-dark ">Xóa</a>
		</td>
		</tr>
<?php
	}
?>
					...
					<a href="manageDatabase.php?page=permissions&&insert" class="btn btn-outline-dark" >Thêm</a>
                    </div>
                  </div>
                </div>
              </div>
