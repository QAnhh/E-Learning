							...
							<div class="x_title">
								<h2>Edit</h2>
									...
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="#" method="post">
										...
										<div class="item form-group">
											<label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">student exercises submissions id </label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="studentExercisesSubmissionsID" class="form-control" value="<?php echo $profile['student_exercises_submissions_id'] ?>">
											</div>
										</div>
										<div class="ln_solid"></div>
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
												<a href="manageDatabase.php?page=comment_submissions" class="btn btn-primary ">Back</a>
